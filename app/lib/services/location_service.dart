...
class LocationService {
  ...
  SplayTreeMap<String, String> getCountryCodeRegexMap() {
    final sorted = SplayTreeMap<String, String>.from(
        countryCodeRegexMap, (a, b) => a.compareTo(b));
    return sorted;
  }
  ...
  Future<bool> update() async {
    return _update(_currentLocation);
  }
  ...
  bool setCurrentLocation(String postalCode, String countryCode) {
    ...
    RegExp validatePostalCode =
        RegExp(countryCodeRegexMap[countryCode]!, multiLine: true);
  ...
  Future<bool> _update(loc.LocationData? location) async {
    if (location == null) {
      return false;
    }
    ...
    if (placemark.isNotEmpty) {
      ...
      // TODO: can return true while not updating postal and country code
      return true;
    }
    return false;
  }
